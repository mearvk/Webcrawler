...
public class FileUtils
{
    ...
    public static String dofullsitepersist(WebcrawlerParam param) throws Exception
    {
        ...
        String basedir = Webcrawler.BASEDIR +SLASH+ smonth+"-"+sday+"-"+syear +SLASH+ Utils.doURLnormalization(param.FULL_DOMAIN_NAME) + (param.PATH.equals("") ? "" : Utils.dofileseparatornormalization(SLASH+ param.PATH));
