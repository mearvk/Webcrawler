package webcrawler.implementations.one;

import webcrawler.exceptions.StackDepthException;
import webcrawler.implementations.one.initialization.Initializer;
import webcrawler.implementations.one.initialization.Preinitialization;
        ...
        while(running)
        {
            ...
            {            
                try
                {
                    ...
                    System.out.println("Thread \""+this.getName()+"\" now working with \""+param.baseURL+"\" - "+queue.size()+" out of "+this.original_size+" sites remain.");
