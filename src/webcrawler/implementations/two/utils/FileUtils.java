...
public class FileUtils
{
    ...
    public static synchronized File doclearfileurl(File file)
    {
        ...
        if(DIVISIONS==5)
            NEWFILENAME = FILENAME.substring(0,254) +SLASH+ FILENAME.substring(255,509) +SLASH+ FILENAME.substring(510,764) +SLASH+ FILENAME.substring(765,1019) +SLASH+ FILENAME.substring(1020, 1274) +SLASH+ FILENAME.substring(1275, 1529) +SLASH+ FILENAME.substring(1530);
        ...
        return new File(NEWFILENAME.replace("\\\\","\\"));
    }
    ...
    public static synchronized void persistfile(WebcrawlerParam param, String inputURL, String outputURL) throws Exception
    {
        ...
        try
        {
            ...
            String correctedfilename = outputURL +SLASH+ Utils.doURLnormalization(filename);
    ...
    public static synchronized void persistimage(WebcrawlerParam param, String inputURL, String outputURL) throws Exception
    {
        ...
        try
        {
            ...
            os = new FileOutputStream(outputURL +SLASH+ filename);
